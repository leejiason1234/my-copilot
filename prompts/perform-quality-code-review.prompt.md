---
agent: agent
description: Perform a quality code review based on a comprehensive checklist.
model: Claude Sonnet 4.5 (copilot)
tools: ['runCommands', 'edit/createFile', 'edit/editFiles', 'search', 'usages']
---
...
When performing a code review, verify if test code is created.
- **Test Code Path**: /root/tests/unit-tests
